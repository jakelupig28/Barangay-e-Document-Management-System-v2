  ...
  <div class="request-wrapper">
    ...
    <div class="request-header">
      <div class="header-content">
        ...
        <!-- <p class="request-subtitle">Submit a maintenance, safety, or complaint report directly to your barangay office.</p> -->
      </div>
    </div>
    ...
    <div class="request-content">
      <div class="request-card">
        <div class="card-body">
          <form @submit.prevent="submitReport" class="request-form">
            ...
            <div v-if="report.reportType === 'other'" class="form-group">
              <label class="form-label">Specify Report Type</label>
              <input 
                v-model="report.otherType" 
                type="text" 
                class="form-input"
      ...
      <div class="modal-container">
        <div class="modal-content">
          <div class="success-message">
            ...
            <p class="instructions">You can track your report status in your dashboard or using the reference ID above.</p>
...
export default {
  ...
  methods: {
    ...
    async uploadFiles(reportId) {
      if (this.selectedFiles.length === 0) return []

      const uploadPromises = this.selectedFiles.map(async (file, index) => {
        const fileExtension = file.name.split('.').pop()
        const fileName = `reports/${reportId}/photo_${index + 1}_${Date.now()}.${fileExtension}`
    ...
    async submitReport() {
      try {
        ...
        // Upload files if any
        const photoUrls = await this.uploadFiles(this.reportId)
        ...
        const reportData = {
          ...
          reportType: this.report.reportType === 'other' ? this.report.otherType : this.report.reportType,
