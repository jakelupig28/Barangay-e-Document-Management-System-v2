  ...
  setup() {
    ...
    const getDocumentTitle = (type) => {
      const titles = {
        ...
        'barangay-certificate': 'BARANGAY CERTIFICATE',
        'certificate-of-indigency-financial': 'BARANGAY CERTIFICATE OF INDIGENCY',
        'certificate-of-indigency-general': 'BARANGAY CERTIFICATE OF INDIGENCY',
        // fallbacks
        'barangay-clearance': 'BARANGAY CERTIFICATE',
        'barangay-id': 'BARANGAY IDENTIFICATION',
        'residency-certificate': 'BARANGAY CERTIFICATE',
        'certificate-of-residency': 'BARANGAY CERTIFICATE',
        'indigency-certificate': 'BARANGAY CERTIFICATE OF INDIGENCY',
    ...
    const handleDownload = async () => {
      ...
      try {
        ...
        const fileName = `Barangay_${getDocumentTypeLabel(requestData.value.type).replace(/\s+/g, '_')}_${requestData.value.documentId || 'document'}`;
