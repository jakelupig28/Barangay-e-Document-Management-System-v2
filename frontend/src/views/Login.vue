      ...
      <div class="auth-right">
        ...
        <div class="auth-card">
          ...
          <form @submit.prevent="login" class="auth-form">
            <div v-if="maintenanceMode" class="maintenance-alert mb-3">
              <i class="fas fa-exclamation-triangle"></i> System under maintenance. Only Super Admin logins are permitted.
            </div>

            <div class="form-group floating-group bg-transparent">
              <select v-model="selectedRole" class="modern-input custom-select" id="roleSelect" :disabled="maintenanceMode">
            ...
            <div class="form-group floating-group bg-transparent pr-0">
            ...
            <div v-if="!maintenanceMode" class="auth-divider">
              <span>OR</span>
            </div>

            <div v-if="!maintenanceMode" class="text-center">
...
export default {
  ...
  methods: {
    async login() {
      ...
      this.loading = true;
      try {
        if (this.maintenanceMode && this.selectedRole !== 'super_admin') {
          throw new Error('Only Super Admin logins are permitted during maintenance.');
        }
...
.form-group.floating-group.bg-white {
...
.auth-wrapper.dark-mode .auth-container {
  background: #1e293b;
  box-shadow: 0 20px 40px rgba(0, 0, 0, 0.4), 0 0 1px 1px rgba(255, 255, 255, 0.1);
  border: 1px solid rgba(255, 255, 255, 0.05);
}

.auth-wrapper.dark-mode .auth-left {
  background: linear-gradient(135deg, #090d16 0%, #1e1b4b 100%);
  border-right: 1px solid rgba(255, 255, 255, 0.05);
}

.auth-wrapper.dark-mode .auth-right {
  background: #1e293b;
}

.auth-wrapper.dark-mode .back-link {
  color: #94a3b8;
}

.auth-wrapper.dark-mode .back-link:hover {
  color: #60a5fa;
}

.auth-wrapper.dark-mode .auth-header h2 {
  color: #f8fafc;
}

.auth-wrapper.dark-mode .auth-header p {
  color: #94a3b8 !important;
}

.auth-wrapper.dark-mode .floating-label {
  color: #94a3b8;
}

.auth-wrapper.dark-mode .modern-input {
  background-color: #0f172a;
  border-color: #334155;
  color: #f8fafc;
}

.auth-wrapper.dark-mode .modern-input:focus {
  border-color: #60a5fa;
  box-shadow: 0 0 0 3px rgba(96, 165, 250, 0.15);
  background-color: #090d16;
}

.auth-wrapper.dark-mode .modern-input:focus ~ .floating-label,
.auth-wrapper.dark-mode .modern-input:not(:placeholder-shown) ~ .floating-label,
.auth-wrapper.dark-mode .custom-select ~ .floating-label {
  color: #60a5fa;
}

.auth-wrapper.dark-mode .modern-input:focus ~ .input-icon {
  color: #60a5fa;
}

.auth-wrapper.dark-mode .input-icon {
  color: #475569;
}

.auth-wrapper.dark-mode .toggle-password {
  color: #64748b;
}

.auth-wrapper.dark-mode .toggle-password:hover {
  color: #94a3b8;
}
...
.auth-wrapper.dark-mode .submit-btn:hover {
  box-shadow: 0 6px 16px rgba(37, 99, 235, 0.55);
}

.auth-wrapper.dark-mode .auth-divider {
  color: #475569;
}

.auth-wrapper.dark-mode .auth-divider::before,
.auth-wrapper.dark-mode .auth-divider::after {
  border-color: #334155;
}

.auth-wrapper.dark-mode .register-link-btn {
  background: #334155;
  color: #f1f5f9;
  border-color: #475569;
}

.auth-wrapper.dark-mode .register-link-btn:hover {
  background: #475569;
  color: #ffffff;
}

.auth-wrapper.dark-mode .admin-hint {
  background: #111827;
  border-color: #334155;
}

.auth-wrapper.dark-mode .admin-hint small {
  color: #94a3b8 !important;
}

.auth-wrapper.dark-mode .admin-hint b {
  color: #f8fafc;
}

.auth-wrapper.dark-mode select.custom-select {
...
.auth-wrapper.dark-mode select.custom-select option {
  background: #0f172a;
  color: #f8fafc;
}

.auth-wrapper.dark-mode .maintenance-alert {
  background: #2e1a05;
  color: #f59e0b;
  border-color: #b45309;
}
